function Resume-AutomationStack {
  ...
  #        "osType": "Windows",
    ...
    Write-Host 'created' -ForegroundColor Green
        ...
        $storageDeploy = Start-ARMDeployment -ResourceGroupName $CurrentContext.Get('ResourceGroup') -Template 'appserver.storage' -TemplateParameters @{
    ...
    $octopusDeploy = Start-ARMDeployment -ResourceGroupName $CurrentContext.Get('ResourceGroup') -Template 'appserver.resume' -TemplateParameters @{
        udp = $CurrentContext.Get('UDP')
        productName = 'Octopus'
