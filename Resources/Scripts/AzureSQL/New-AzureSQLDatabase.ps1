...
New-AzureRmSqlDatabase -ResourceGroupName $ResourceGroupName -ServerName $ServerName -DatabaseName $DatabaseName -CollationName 'SQL_Latin1_General_CP1_CI_AS' -Edition 'Basic' -Tag (Get-AzureRmResourceGroup -Name $ResourceGroupName).Tags | Out-Host
